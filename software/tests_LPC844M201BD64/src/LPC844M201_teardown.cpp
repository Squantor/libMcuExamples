...
{
    sysconEnableClocks(SYSCON, CLKCTRL0_I2C0, CLKCTRL1_NONE);
    sysconEnableResets(SYSCON, RESETCTRL0_I2C0, RESETCTRL1_NONE);
    sysconDisableResets(SYSCON, RESETCTRL0_I2C0, RESETCTRL1_NONE);
    sysconDisableClocks(SYSCON, CLKCTRL0_I2C0, CLKCTRL1_NONE);
