...
MINUNIT_TEARDOWN(LPC824M201HI33Teardown) {
  ...
  PININT->ISEL = 0x00000000;
  PININT->IENR = 0x00000000;
  PININT->IENF = 0x00000000;
  PININT->RISE = 0x000000FF;
  PININT->FALL = 0x000000FF;
  PININT->IST = 0x000000FF;
...
bool LPC824M201HI33TeardownCorrect(void) {
  ...
  TESTANDRETURN(PININT->ISEL == 0x00000000);
  TESTANDRETURN(PININT->IENR == 0x00000000);
  TESTANDRETURN(PININT->IENF == 0x00000000);
  TESTANDRETURN(PININT->RISE == 0x00000000);
  TESTANDRETURN(PININT->FALL == 0x00000000);
  TESTANDRETURN(PININT->IST == 0x00000000);
  sysconDisableClocks(SYSCON, CLKCTRL_GPIO);
