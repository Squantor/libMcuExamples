...
bool LPC845M301TeardownCorrect(void)
{
    ...
    TESTANDRETURN(SWM0->PINASSIGN_DATA[0] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[1] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[2] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[3] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[4] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[5] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[6] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[7] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[8] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[9] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[10] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[11] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[12] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[13] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINASSIGN_DATA[14] == 0xFFFFFFFF);
    TESTANDRETURN(SWM0->PINENABLE0 == 0xFFFFFC1F);
    TESTANDRETURN(SWM0->PINENABLE1 == 0x0000007F);
    ...
    TESTANDRETURN(USART0->BRG == 0x00000000);
